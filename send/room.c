...
ConnectToServer(const char *hostname, int port)
{
  ...
  p+=sprintf(p,"<s:Envelope s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\"><s:Body><u:Login xmlns:u=\"urn:av-openhome-org:service:Spotify:1\"><UserName>\"hello\"</UserName><PassWord>\"dddss\"</PassWord></u:Login></s:Body></s:Envelope>");
  */
  p+=sprintf(p,"POST /ddddd/av.openhome.org-Lightning-1/control HTTP/1.1\r\n");
  p+=sprintf(p,"Content-Type: text/xml; charset=\"utf-8\"\r\n");
  p+=sprintf(p,"SOAPACTION: \"urn:av-openhome-org:service:Lightning:1#SetRoomName\"\r\n");
  p+=sprintf(p,"Content-Length: 265\r\n");//很重要
  p+=sprintf(p,"Connection: close\r\n");
  p+=sprintf(p,"Host: 192.168.1.113:33198\r\n");
  p+=sprintf(p,"\n\r");
  p+=sprintf(p,"<s:Envelope s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\"><s:Body><u:SetRoomName xmlns:u=\"urn:av-openhome-org:service:Lightning:1\"><RoomName>changpeng</RoomName></u:SetRoomName></s:Body></s:Envelope>");
